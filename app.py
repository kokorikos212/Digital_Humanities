...
""")
                    ...
                    with gr.Column(scale=1):
                        ...
                        gr.HTML("""<style>.cmd-chip{display:inline-block;padding:2px 8px;margin:2px;background:#4a6cf720;color:#4a6cf7;border-radius:10px;font-size:11px;cursor:pointer;border:none;font-weight:500}.cmd-chip:hover{background:#4a6cf7;color:#fff}</style>
